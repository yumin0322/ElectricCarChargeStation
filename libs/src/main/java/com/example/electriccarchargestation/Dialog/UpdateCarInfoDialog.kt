...
class UpdateCarInfoDialog (val context: Context, val carInfo2binding: ActivityCarInfoBinding) {
    ...
    fun showDialog(){
        ...
        binding.btnCarInfo2Renew.setOnClickListener {
            ...
            carInfo2binding.tvCarInfo2Name.text=binding.edtCarInfo2ReName.text

            carInfo2binding.tvCarInfo2Type.text=binding.spinner2.selectedItem.toString()
