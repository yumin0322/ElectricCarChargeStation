...
class CarInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvCarInfo2Name.text= carInfo?.carName

        val myChargeType = carInfo?.chargeType

        binding.tvCarInfo2Type.text = if(myChargeType == 1){
            "DC차데모"
        ...
        binding.ivCarInfo2Back.setOnClickListener {
        ...
        binding.btnCarInfo2RePhoto.setOnClickListener {
